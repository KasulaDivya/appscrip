    ...
    <>
      <header className="header">
        <div className="top-section">
          <button className="menu-toggle" id='navbar' onClick={toggleMenu}>
            <img  src="Group 48100065.png" alt="Menu" /> 
          </button>
          <div className="logo">
            <img style ={{marginLeft:"100%"}} src="/Logo.png" alt="Logo" />
          </div>
          <div className="logopage">
            <center><h1 className="change">LOGO</h1></center>
          </div>
          <div className="icons">
      ...
      <div className="discover-section">
        <h2 className='h22'>DISCOVER OUR PRODUCTS</h2>
